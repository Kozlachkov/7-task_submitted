...
# нескольких форматах. Предполагается возможность вывода всех контактов, поиска 
# контакта по имени, добавления и удаления контакта
import controller.mainController as mC
import view.our_DB as DB
from model.Person import Person as Person
